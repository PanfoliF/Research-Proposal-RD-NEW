...
\begin{center}
    \subsection*{Abstract}
\end{center}
This research proposal investigates the determinants of educational outcomes in Brazil through a causal-inference framework. Motivated by the persistent empirical uncertainty surrounding "what works" in education, the study exploits Brazil's federal structure and rich subnational variation to estimate the effect of school inputs on student performance and progression.  ￼

\vspace*{1em}
Empirically, the project relies on the Brazilian Education Panel Databases (Huberts et al., 2025), a harmonized panel covering the period 1996–2015 and providing granular observations suitable for within-unit comparisons over time. The analysis builds on a causal directed acyclic graph (DAG) and a two-margin conceptualization of outcomes. Teacher quality is operationalized using measurable proxies--teachers' education and class size (students per class)--and is complemented by indicators of school infrastructure and a set of controls.  ￼
