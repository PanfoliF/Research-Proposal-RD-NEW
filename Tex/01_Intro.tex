...
Potential data sources include IPUMS and the Instituto Brasileiro de Geografia e Estatística (IBGE). Additionally, aggregated data may be retrieved from the Brazilian Education Panel Databases, which covers the period from 1996 to 2015. Eventually, the article from \textcite{rubianedanielecardosodealmeidaDemographicAspectsRegional2023} offers panel data on some demographic aspects.
\vspace{1em}
