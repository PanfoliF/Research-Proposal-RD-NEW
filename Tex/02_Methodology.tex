...
\]
\textit{Teachers quality} is measured as teachers education.
...
\gamma' X_{smt} + \mu_m + \lambda_t + \varepsilon_{smt}
\]
Teachers Quality is measured teachers education. Again, identification relies on municipal FE, state FE and year FE\@. This regression uses the same controls as above.
