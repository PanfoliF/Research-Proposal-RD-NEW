...
This strategy isolates the effect of teacher quality on students test scores, which is commonly refered to as \textit{outcome variable}.
...
Again, identification relies on municipal FE, state FE and year FE\@.
